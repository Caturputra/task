...
<tr>
    ...
    if (isset($_SESSION['items'])) {
        foreach ($_SESSION['items'] as $key => $val) {
            $query = mysqli_query($koneksi, "select * from barang where product_id = '$key'");
            ...
            ?>
                ...
                <td><center><a href="cart.php?act=plus&amp;product_id=<?php echo $key; ?>&amp;ref=detail_cart.php" class="btn btn-xs btn-success">Tambah</a> <a href="cart.php?act=min&amp;product_id=<?php echo $key; ?>&amp;ref=detail_cart.php" class="btn btn-xs btn-warning">Kurang</a> <a href="cart.php?act=del&amp;product_id=<?php echo $key; ?>&amp;ref=detail_cart.php" class="btn btn-xs btn-danger">Hapus</a></center></td>
                </tr>
				...
				if($total == 0){
					...
					echo '
						...
						<p><div align="right">
						<a href="product_all.php" class="btn btn-info">&laquo; CONTINUE SHOPPING</a>
